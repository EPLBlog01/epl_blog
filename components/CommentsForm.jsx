...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Poster un commentaire</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Se souvenir de mes informations dans ce navigateur.</label>
        </div>
      </div>
